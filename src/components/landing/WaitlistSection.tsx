...
export const WaitlistSection: React.FC = () => {
    ...
    return (
        <section className="relative min-h-screen flex items-center justify-center bg-black py-20 px-4 sm:px-6 overflow-hidden">
            ...
            <div className="absolute inset-0">
                <Particles
                    ...
                    particleSpread={15}
                    speed={0.15}
                    particleColors={['#ffffff', '#ec4899', '#f97316']}
            ...
            <div className="relative z-10 max-w-3xl mx-auto text-center space-y-8">
                ...
                >
                    <input
                        ...
                        required
                        className="flex-1 h-12 px-4 bg-zinc-900/80 backdrop-blur-sm border border-white/10 rounded-lg text-white placeholder:text-zinc-500 focus:outline-none focus:border-pink-500 focus:ring-2 focus:ring-pink-500/20 transition-all"
                    />
                    <button
                        type="submit"
                ...
                <motion.div
                    ...
                    className="space-y-2"
                >
                    <div className="w-full max-w-md mx-auto h-2 bg-zinc-800/50 backdrop-blur-sm rounded-full overflow-hidden">
                        <motion.div
                            initial={{ width: 0 }}
